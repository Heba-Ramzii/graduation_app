...
showMyDialog(
    BuildContext context, String title, String text, Function()? onPressed) {
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        contentPadding: const EdgeInsets.only(
            top: 20, bottom: 45), // Message which will be pop up on the screen
        actions: <Widget>[
          MaterialButton(
            // minWidth: 100,
          ...
          MaterialButton(
            ...
            child: Padding(
              padding: const EdgeInsets.symmetric(vertical: 10.0),
              child:
                  Text(text, style: StyleManager.buttonTextStyle16.copyWith()),
            ),
          ),
        ],
      );
